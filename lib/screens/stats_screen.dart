...
class _StatsScreenState extends State<StatsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final stats = _activityService.getStats();
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                ...
                _buildStatCard(
                  'Total Elevation',
                  '${(stats['totalElevation']).toStringAsFixed(0)}m',
                  Icons.terrain,
                  Colors.purple,
                ),
              ],
              ...
              child: Row(
                ...
                children: [
                  Column(
                    children: [
                      Text(
                        _formatDistance(stats['averageDistance']),
    ...
    return Container(
      ...
      child: Column(
        children: [
          _buildBreakdownRow(
            'Running',
            counts[ActivityType.running]!,
            distances[ActivityType.running]!,
            Colors.orange,
          ...
          _buildBreakdownRow(
            'Walking',
            counts[ActivityType.walking]!,
            distances[ActivityType.walking]!,
            Colors.green,
          ...
          _buildBreakdownRow(
            'Cycling',
            counts[ActivityType.cycling]!,
            distances[ActivityType.cycling]!,
            Colors.blue,
